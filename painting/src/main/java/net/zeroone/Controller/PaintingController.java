 ...
 * As a user, I should able to get a single painting by its id using a GET request to localhost:7070/painting/{id}, which will return a JSON of a single painting
 * 
